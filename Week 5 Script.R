...
download.file(url = "https://projects.fivethirtyeight.com/soccer-api/international/2022/wc_matches.csv", destfile = "/Users/prakharmotwani/Downloads/WorldCup.csv")

#Then you need to name your dataset. Run this:
WorldCup <- read.csv("/Users/prakharmotwani/Downloads/WorldCup.csv")
